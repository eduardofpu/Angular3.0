...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.httpBasic().and().authorizeRequests()
				...
				.antMatchers(HttpMethod.GET, ServicePath.EDITUSER_PATH).hasAnyAuthority(AUTH_USER, AUTH_ADMIN)
				.antMatchers(HttpMethod.POST, ServicePath.EDITUSER_PATH).hasAnyAuthority(AUTH_USER, AUTH_ADMIN)
				.antMatchers(HttpMethod.PUT, ServicePath.EDITUSER_PATH).hasAnyAuthority(AUTH_USER, AUTH_ADMIN)
				.antMatchers(HttpMethod.DELETE, ServicePath.EDITUSER_PATH).hasAnyAuthority(AUTH_USER, AUTH_ADMIN)

				// Permission Authorities.
				.antMatchers(HttpMethod.GET, ServicePath.PERMISSION_PATH).hasAnyAuthority(AUTH_USER, AUTH_ADMIN)
